...
export const projects = [
  ...
  {
    title: "Todo list",
    github: "https://github.com/jovyzabel/todo-list",
    description: [
  ...
  {
    title: "House",
    github: "https://github.com/jovyzabel/ng-homes",
    description: [
      "A simple house listing app.",
      "Built with Angular 18",
      "Usage of standalone components",
    ],
  },
...
export const awards = [
  ...
  {
    name: "FreeCodeCamp Algorithms and Data Structures",
    issuer: "FreeCodeCamp",
    date: "Mars 2025",
    type: "International",
    position: "*",
